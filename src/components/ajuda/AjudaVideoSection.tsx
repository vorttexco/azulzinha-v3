...
const categories: Category[] = [
  {
    ...
    videos: [
      ...
      { title: "Conheça a azulzinha, a maquininha da CAIXA" },
      { title: "Como fazer vendas no débito e crédito na azulzinha" },
      { title: "Como fazer vendas parceladas na azulzinha" },
      { title: "Como conectar sua azulzinha pro no Wi-fi" },
      { title: "Como cuidar da bateria da sua azulzinha" },
      { title: "Como funciona o App da azulzinha" },
      { title: "Primeiro acesso no App da azulzinha" },
      { title: "Como usar a Agenda Financeira no App da azulzinha?" },
      { title: "Dicas para usar a azulzinha da CAIXA com segurança" },
      { title: "Como consultar o extrato no App da azulzinha" },
      { title: "Como cancelar uma venda no App da azulzinha" },
      { title: "Como fazer uma antecipação de recebíveis no App da azulzinha?" },
      { title: "Como solicitar bobinas pelo App da azulzinha" },
      { title: "Como consultar o histórico de recargas pelo App da azulzinha" },
      { title: "Como consultar as taxas e tarifas da azulzinha pelo App" },
      { title: "Como declarar imposto de renda pelo App da azulzinha" },
      { title: "Cancelamento de Venda App azulzinha" },
      { title: "Agora tem azulzinha no App CAIXA Tem!" },
      { title: "Como gerar um Link de Pagamento no App CAIXA Tem?" },
      { title: "Como fazer uma venda com QR Code no App CAIXA Tem?" },
      { title: "Como fazer uma venda por aproximação no App CAIXA Tem?" },
      { title: "Como consultar suas vendas no App CAIXA Tem?" },
      { title: "Como consultar seus recebimentos no App CAIXA Tem?" },
      { title: "Como consultar as taxas e tarifas da função azulzinha?" },
      { title: "Como tirar suas dúvidas no App CAIXA Tem?" },
      { title: "Como gerar link de pagamento com o App da azulzinha?" },
      { title: "Como ver o histórico de links de pagamento gerados no App da azulzinha?" },
      { title: "Como acessar o Portal do Cliente da azulzinha" },
      { title: "Serviço de Conveniência" },
